...
const Education: any = () => {
	return (
		<div id="education" className="flex flex-col gap-8 text-lg lg:p-6 mb-16 md:mb-24 scroll-mt-16 hover_border">
			<Link href="https://en.ktu.edu/" className="flex items-center gap-2 group">
				...
				<div className="group-hover:text-secondary">
					...
					<p className="text-sm group-hover:text-secondary">Bachelor's degree in Information System Design</p>
				</div>
			</Link>
			...
			<Link href="https://bit.lt/" className="flex items-center gap-2 group">
				...
				<div className="group-hover:text-secondary">
					...
					<p className="text-sm group-hover:text-secondary">Full-stack developer JavaScript + PHP</p>
				</div>
			</Link>
		</div>
	);
